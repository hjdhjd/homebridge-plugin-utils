...
| <a id="masthead"></a> `masthead` | `readonly` | [`Masthead`](#masthead-2) |
...
row, and tagline block. See [docChromeRegions](#docchromeregions).

#### Properties

| Property | Modifier | Type |
| ------ | ------ | ------ |
| <a id="documentation"></a> `documentation` | `readonly` | `boolean` |
| <a id="masthead-1"></a> `masthead` | `readonly` | `boolean` |
...
```ts
const LOGO_BEGIN: "<!-- LOGO:BEGIN - Auto-generated by homebridge-plugin-utils. Do not edit this region by hand. -->" = "<!-- LOGO:BEGIN - Auto-generated by homebridge-plugin-utils. Do not edit this region by hand. -->";
```

The opening marker of the auto-generated logo region (webUI only). See [renderLogo](#renderlogo).
...
```ts
const LOGO_END: "<!-- LOGO:END -->" = "<!-- LOGO:END -->";
```

The closing marker of the auto-generated logo region. See [LOGO\_BEGIN](#logo_begin).
...
```ts
function docChromeRegions(entry): DocChromeRegionPlan;
```
...
| ------ | ------ | ------ |
| `entry` | [`DocEntry`](#docentry) | The documentation-index entry to plan. |

#### Returns

[`DocChromeRegionPlan`](#docchromeregionplan)

The regions the entry's file carries.
...
```ts
function renderLogo(manifest): string;
```
...
The rendered image element, a single line.
