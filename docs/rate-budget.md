...
Time is the wall clock. Grants are pruned from the front of the log on the premise that timestamps never decrease, and the production [Clock](clock.md#clock) reads
