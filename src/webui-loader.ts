...
const BOOT_MONITOR: readonly string[] = [
  ...
  "    };",
  "",
  "    // Stop watching: clear the watchdog and remove both window listeners. Called from every terminal path, so nothing is left open once the boot has resolved one",
  "    // way or the other.",
  "    const stop = () => {",
  "",
